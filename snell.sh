...
auto_update_script() {
    ...
    # 下载最新版本
    if curl -sL https://raw.githubusercontent.com/llodys/snell/main/snell.sh -o "$TMP_SCRIPT"; then
        # 获取新版本号
...
setup_multi_user() {
    ...
    bash <(curl -sL https://raw.githubusercontent.com/llodys/snell/main/multi-user.sh)
...
setup_bbr() {
    ...
    # 直接从远程执行BBR脚本
    bash <(curl -sL https://raw.githubusercontent.com/llodys/snell/main/bbr.sh)
...
setup_shadowtls() {
    ...
    bash <(curl -sL https://raw.githubusercontent.com/llodys/snell/main/shadowtls.sh)
